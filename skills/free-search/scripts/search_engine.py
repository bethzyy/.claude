...
v3.3.0 - 移除ZhipuMCP，简化为4级fallback
"""
import sys
import os
...
class WebSearchEngine:
    ...
    架构说明：
    - 移除了ZhipuMCP以简化架构
    - v3.3.0 移除ZhipuMCP，改为从Tavily开始fallback
    """
    ...
    def __init__(self, cache_days: int = 7):
        ...
        # 初始化providers（按优先级顺序）
        self.providers = [
            TavilyProvider(),               # Priority 1: 第三方服务，独立配额
            SerperProvider(),               # Priority 2: Google搜索结果API
